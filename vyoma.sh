...
pip install cocotb tabulate fxpmath numpy
...
cp -r /workspace/.pyenv_mirror/user/3.8.13/lib/python3.8/site-packages/fxpmath* /home/gitpod/.pyenv/versions/3.8.13/lib/python3.8/site-packages/
cp -r /workspace/.pyenv_mirror/user/3.8.13/lib/python3.8/site-packages/numpy* /home/gitpod/.pyenv/versions/3.8.13/lib/python3.8/site-packages/
rm -rf core.*
clear
